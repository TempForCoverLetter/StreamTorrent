...
import concat from 'simple-concat/index.js'
...
import { remote } from 'parse-torrent' //my edit
...
export default class WebTorrent extends EventEmitter {
  ...
  async get (torrentId) {
    if (torrentId instanceof Torrent) {
      ...
      let parsed
      try { parsed = await remote(torrentId, (err, parsedtorrent) => { return parsedtorrent })} catch (err) {} /* my add */
